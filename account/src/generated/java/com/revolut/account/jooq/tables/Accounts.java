...
public class Accounts extends TableImpl<AccountsRecord> {
    ...
    private static final long serialVersionUID = 2079175928;
     ...
     */
    public final TableField<AccountsRecord, UUID> CUSTOMER_ID = createField("CUSTOMER_ID", org.jooq.impl.SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>PUBLIC.ACCOUNTS.CURRENCY</code>.
     */
    public final TableField<AccountsRecord, String> CURRENCY = createField("CURRENCY", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.ACCOUNTS.CREATION_DATE</code>.
     */
    public final TableField<AccountsRecord, OffsetDateTime> CREATION_DATE = createField("CREATION_DATE", org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE.precision(10).nullable(false), this, "");
